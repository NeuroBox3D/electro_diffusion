...
#ifndef UG__PLUGINS__EXPERIMENTAL__NERNST_PLANCK__PNP1D_FV1_H_
#define UG__PLUGINS__EXPERIMENTAL__NERNST_PLANCK__PNP1D_FV1_H_
...
template <typename TElem, int TWorldDim> class FV1Geometry;
...
/// 1D PNP element discretization for FV1
...
class PNP1D_FV1: public IElemDisc<TDomain>
{
	public:
		...
		///	constructor
		PNP1D_FV1(SmartPtr<ApproximationSpace<TDomain> > approx,
...
#endif // UG__PLUGINS__EXPERIMENTAL__NERNST_PLANCK__PNP1D_FV1_H_
